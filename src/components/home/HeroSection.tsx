      ...
      <div className="container mx-auto px-4 lg:px-8 pt-32 pb-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-primary-foreground">
            ...
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-fade-up" style={{ animationDelay: "0.1s" }}>
              O maior marketplace de
              <span className="block text-accent">testes de desenvolvimento</span>
              pessoal do Brasil
            </h1>
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-8 mt-12 pt-8 border-t border-primary-foreground/10 animate-fade-up" style={{ animationDelay: "0.4s" }}>
              <div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative w-full aspect-square max-w-lg mx-auto">
              ...
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-20 h-20 rounded-2xl bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/20 flex items-center justify-center animate-float" style={{ animationDelay: "1s" }}>
                <Users className="w-10 h-10 text-accent" />
              </div>
              <div className="absolute left-0 top-1/2 -translate-y-1/2 w-20 h-20 rounded-2xl bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/20 flex items-center justify-center animate-float" style={{ animationDelay: "2s" }}>
                <Sparkles className="w-10 h-10 text-sozo-beige" />
              </div>
              <div className="absolute right-0 top-1/2 -translate-y-1/2 w-20 h-20 rounded-2xl bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/20 flex items-center justify-center animate-float" style={{ animationDelay: "3s" }}>

...
<div style="max-width:800px;margin:0 auto;font-family:'Segoe UI',Arial,sans-serif;color:#1a1a2e;line-height:1.7;">
  <div style="text-align:center;padding:30px;background:linear-gradient(135deg,#0f3460,#533483);color:white;border-radius:12px;margin-bottom:30px;">
    ...
    <p style="margin:0;font-size:18px;">Temperamento ${primaryLabel} e ${secondaryLabel}</p>
  ...
  <div style="display:flex;gap:16px;justify-content:center;margin-bottom:24px;">
    ...
    <div style="text-align:center;">
      <div style="width:60px;height:60px;border-radius:50%;background:${TEMPERAMENTO_COLORS[t]};color:white;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:18px;margin:0 auto 8px;">${percentages[t]}%</div>

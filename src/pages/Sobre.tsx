        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg text-muted-foreground">
              <p className="mb-4">
                O Instituto Plenitude Sozo nasceu da paixão por ajudar pessoas a descobrirem 
                seu verdadeiro potencial. Fundado por Everton, o instituto começou como um 
                pequeno consultório e hoje se tornou o maior marketplace de testes de 
